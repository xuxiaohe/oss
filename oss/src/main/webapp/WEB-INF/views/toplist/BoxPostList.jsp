	...
	<div class="container-fluid">
		...
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<c:if test="${addDryBoxposition.status == '200'}">
						...
						<div class="row" style="padding: 20px;">
							...
							<div class="col-xs-10">
								<h4 style="margin-left: 12px;">
									<a href="${cbasePath}area/InBoxList?id=${Recourse.id}&type=${type}&name=${Recourse.chinaName}">
										${Recourse.chinaName} </a><br> <small><small
								...
								<div class="col-xs-12 btn-group-sm">
									<button data="${Recourse.id}" data2="${type}" type="button"
					...
					.click(
							function() {
								if (window.confirm('你确定要删除吗？')) {
									...
									window.location.href = "${cbasePath}area/BoxListDelete?boxId="
											+ $(this).attr("data")+"&type="+$(this).attr("data2");
								} else {
