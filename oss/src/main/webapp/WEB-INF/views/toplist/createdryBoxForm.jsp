		...
		<div class="row">
			...
			<div class="col-xs-9">
				<form role="form" method="post"
					action="${cbasePath}area/addDryBoxAction" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label for="exampleInputEmail1">选择类别</label> 
							<select class="form-control" name="type" id="uidSelect">
							 
								<c:forEach items="${typelist}" varStatus="key"
									var="Recourse">
