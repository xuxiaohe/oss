...
<body>
	...
	<div class="panel-body">
		...
		<div class="panel panel-default">
			...
			<c:forEach items="${addDryBoxposition.data.result}" varStatus="key"
						var="Recourse">
				<li><a href="${cbasePath}category/categoryBoxList?id=${Recourse.id}&name=${Recourse.chinaName}">${Recourse.chinaName}</a></li>
				</c:forEach>
		...
		<div class="btn-group">
		<form class="form-inline" action="${cbasePath}category/searchCategoryBoxList?id=${id}&name=${name}"
				...
				<c:if test="${addDryBoxList.status == '200'}">
					...
					<ul class="pagination">
						<pageNation:PageNation currPage="${addDryBoxList.data.curr_page}"
							...
							linkBaseUrl="${cbasePath}category/categoryBoxList?id=${id}&name=${name}">
						...
						<div class="row" style="padding: 20px;">
							...
							<div class="col-xs-10">
								 <h4 style="margin-left: 12px;">
									<a href="${cbasePath}category/detail?id=${Recourse.id}">
										${Recourse.categoryName} </a><br> <%-- <small><small
								...
								<a href="${cbasePath}category/bindBoxCategory?boxPostId=${id}&sourceId=${Recourse.id}&name=${name}&ctime=${Recourse.ctime}">
