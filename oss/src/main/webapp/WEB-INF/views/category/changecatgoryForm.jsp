		...
		<div class="row">
			...
			<div class="col-xs-9">
				...
				<form role="form" method="post"
					action="${cbasePath}category/changeSecondCategoryAction?fid=${fid}&oldid=${oldid}" enctype="multipart/form-data">
					<div class="form-group">
					当前分类：${categoryDetail2.data.result.categoryName}<br><br>
						<label for="exampleInputEmail1">选择分类</label> 
						
							<select class="form-control" name="newid" id="uidSelect">
							<c:if test="${categoryDetail.status == '200' }">
								<c:forEach items="${categoryDetail.data.result.childCategory}" varStatus="key"
									var="Recourse">
