...
<div class="wrapper">
  ...
  <div class="divTop">
    <div class="logo"><img src="<%=cbasePath%>/resources/assets/images/share/logo.png" /></div>
    <div class="button">
      <a href="itms-services://?action=download-manifest&url=https://passport.yunxuetang.cn/t/yxt/yxt.ipa"><img src="<%=cbasePath%>/resources/assets/images/share/button.png" ></a>
    </div>
    <div class="clear"></div>
  </div>
  ...
  <div class="divTop1">
    <div class="logo"><img src="<%=cbasePath%>/resources/assets/images/share/logo1.png" /></div>
    <div class="button">
      <a href="itms-services://?action=download-manifest&url=https://passport.yunxuetang.cn/t/yxt/yxt.ipa"><img src="<%=cbasePath%>/resources/assets/images/share/button.png" ></a>
    </div>
    <div class="clear"></div>
