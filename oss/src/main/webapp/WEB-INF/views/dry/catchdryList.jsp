								...
								<div class="col-xs-12 btn-group-sm">
									...
									<c:if test="${Recourse.group==''}">
										<a class="btn btn-success"
											href="${cbasePath}dry/updateDryForm?dryid=${Recourse.id}&uid=${Recourse.authorId}">
											关联群组 </a>
									...
									<a 
										class="btn btn-success" href="${cbasePath}dry/checkDry?dryid=${Recourse.id}&uid=${Recourse.authorId}">
										审核干货通过 </a>
									<%-- <button data="${Recourse.id}" type="button" class="deleteBtn btn btn-primary">关联群组</button> --%>
									</c:if>
								</div>
