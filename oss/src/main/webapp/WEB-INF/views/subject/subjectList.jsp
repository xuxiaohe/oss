...
<html>
	...
	<body>
						...
						<div class="row">
							...
							<div class="col-xs-10">
								<h4 style="margin-left:12px;">
									<a href="#" onclick="javascript:specialDetail('${special.id}','${special.chinaName}','${special.type}','${special.logoUrl}','${special.ctime}','${special.h5Url}');">
		...
		<script type="text/javascript">
			...
			function specialDetail(id, chinaName, type, logoUrl, ctime, h5Url){
				var url = '${cbasePath}subject/subjectDetail?chinaName=' + encodeURI(chinaName) + "&id=" + id + "&type=" + type + "&logoUrl=" + logoUrl + '&ctime=' + ctime + '&h5Url=' + h5Url;
