			...
			<c:forEach items="${list.data.result}" varStatus="key"
				...
				<tr>
					<td><input type="checkbox" name="acid" value="${Recourse.id}"
						 /></td>
					<td>${fn:substring(Recourse.message, 0, 15)}</td>
...
<script type="text/javascript">
	...
	*/
	function searchFunction(n, s){
		var url = '${cbasePath}subject/findByothers?pageType=selectDry&boxPostId=${boxPostId}&dataType=dry&categoryId=${categoryId}';
