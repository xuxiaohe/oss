	...
	function closeDialog(){
		...
		$.ajax({
			...
			success : function(data){
				if(data == 'success'){
					alert('添加活动成功');
					var url = '${cbasePath}subject/subjectDetail?chinaName=' + encodeURI(specialName) + "&id=" + boxPostId + "&type=course&logoUrl=" + logoUrl + '&ctime=' + ctime + '&h5Url=' + h5Url + '&categoryId=' + categoryId;
