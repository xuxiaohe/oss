	...
	<div class="container-fluid">
		...
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<c:if test="${FeedBackList.status == '200'}">
					<nav> <!-- 分页开始 -->
					<ul class="pagination">
						<pageNation:PageNation currPage="${FeedBackList.data.curr_page}"
							totalPages="${FeedBackList.data.page_rows}" perPageRows="10"
							totalRows="${FeedBackList.data.total_rows}"
							linkBaseUrl="${cbasePath}feedback/FeedBackList?">
					...
					<c:forEach items="${FeedBackList.data.result}" varStatus="key"
						var="Recourse">
					...
					.click(
							function() {
								if (window.confirm('你确定要删除吗？')) {
									...
									window.location.href = "${cbasePath}feedback/deleteFeedBack?id="
											+ $(this).attr("data");
								} else {
