		...
		<c:if test="${TopicList.status == '200' }">
			...
			<ul class="pagination">
				<pageNation:PageNation currPage="${TopicList.data.curr_page}"
					...
					linkBaseUrl="${cbasePath}group/groupTopic?gid=${Group.data.result.id}">
			...
			<c:forEach items="${TopicList.data.result}" varStatus="key"
				...
				<div id="topicDiv" style="margin: 10px;" class="row">
					...
					<div class="col-xs-10">
						...
						<a class="btnDelete" data="${cbasePath}topic/deleteTopicForGroup?gid=${Group.data.result.id}&topicid=${group.topicId}">
