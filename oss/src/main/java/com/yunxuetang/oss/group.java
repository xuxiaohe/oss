...
public class group {
	...
	private ModelAndView searchGroup(HttpServletRequest request) {
		...
		//当前第几页
				...
				if(keyword==null){
					 courSharResoStr= restTemplate.getForObject(YXTSERVER3+"oss/group/search?n="+pagenumber+"&s="+pagelines, String.class); 
					  ...
					  courSharResoStr= restTemplate.getForObject(YXTSERVER3+"oss/group/search?n="+pagenumber+"&s="+pagelines+"&keyword="+keyword, String.class); 
				}
		...
		try {
			...
			//ResponseContainer rdData = (ResponseContainer) JSON2ObjUtil.getDTO(courSharResoStr, ResponseContainer.class);
			...
			//List<ResponseGroup> rg	 =(List<ResponseGroup>)JSON2ObjUtil.getDTOList(ttt.toString(), ResponseGroup.class);
	...
	public ModelAndView createGroupView(HttpServletRequest request) {
		...
		//当前第几页
			   ...
			   courSharResoStr= restTemplate.getForObject(YXTSERVER3+"oss/user/searchbyinfo?n="+pagenumber+"&s="+pagelines+"&robot=1", String.class); 
